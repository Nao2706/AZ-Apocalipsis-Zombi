...
public class Comandos implements CommandExecutor{
		...
		//COMANDOS QUE PUEDE USAR JUGADOR CANTIDAD
			...
			if(args.length > 0 && player.hasPermission("zombie.op")) {
				if(args[0].equalsIgnoreCase("version")) {
					...
					player.sendMessage(":V sr stark ahora q ? xd");
					return true;
					}
	...
	//==================================================================================			
				   ...
				   Bukkit.broadcastMessage(ChatColor.GREEN+"El Apocalipsis Zombi se a Comenzado");
				...
				Bukkit.broadcastMessage(ChatColor.RED+"El Apocalipsis Zombi se a Detenido");
	...
	//==================================================================================		
			...
			else if(!player.hasPermission("secure.server")) {
				
				player.sendMessage(plugin.nombre+ChatColor.RED+" No tienes permiso para ejecutar este Comando. ");
			}
			
			player.sendMessage(plugin.nombre+ChatColor.RED+" escribe "+ChatColor.YELLOW+"/ssecure info");
